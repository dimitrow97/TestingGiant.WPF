...
{
    public class UserGroupsViewModel : BaseScreenViewModel
    {
        ...
        {
            this.MemberOfGroups = new BindableCollection<GroupModel>(this.usersRepository.GetById(this.User.Id).Groups.Select(x => new GroupModel { Id = x.Id, Name = x.GroupName }).ToList());
            this.NotMemberOfGroups = new BindableCollection<GroupModel>(this.groupsRepository.All().Where(x => !x.Users.Any(y => y.Id == this.User.Id)).Select(x => new GroupModel { Id = x.Id, Name = x.GroupName }).ToList());
        }
        ...
        public void AddToGroup()
        {
            ...
            {
                var user = this.usersRepository.GetById(this.User.Id);

                user.Groups.Add(this.groupsRepository.GetById(this.SelectedNotMemberGroup.Id));
        ...
        public void RemoveFromGroup()
        {
            if(this.SelectedMemberGroup != null)
            {
                ...
                user.Groups.Remove(this.groupsRepository.GetById(this.SelectedMemberGroup.Id));
