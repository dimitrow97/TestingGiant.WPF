...
{
    public class QuestionAddViewModel : BaseScreenViewModel, IDataErrorInfo
    {
        ...
        public void AttemptCreate()
        {
            ...
            if (!questionRepository.All().Any(x => x.Title == this.Title && x.QuestionType == this.SelectedQuestionType))
            {
